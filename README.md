...
- [yuque-mcp-server](https://github.com/chen201724/yuque-mcp-server) — MCP server for Yuque API, bringing knowledge base capabilities to AI assistants
- Building AI-powered developer tools at Yuque
